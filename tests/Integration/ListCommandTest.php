...
final class ListCommandTest extends TestCase
{
     ...
     * (ADR-004). Both arms pass --all so the two runs share the identical 72-rule id set and the
    ...
    public function testNotInRangeRulesAreHiddenByDefaultAndShownWithAll(): void
    {
        ...
        self::assertCount(30, $notInRangeInAll);
    ...
    public function testListRulesAliasRulesWorks(): void
    {
        ...
        self::assertSame(ExitCode::SUCCESS, $exitCode);
        self::assertStringContainsString('Rules: 72 of 72 shown', $tester->getDisplay());
    }
