...
final class ListCommandTest extends TestCase
{
     ...
     * (ADR-004). Both arms pass --all so the two runs share the identical 80-rule id set and the
    ...
    public function testNotInRangeRulesAreHiddenByDefaultAndShownWithAll(): void
    {
        ...
        self::assertSame(80, $default['total']);
        self::assertSame(80, $all['total']);

        $defaultRules = self::objList($default['rules']);
        $allRules = self::objList($all['rules']);

        self::assertCount(42, $defaultRules);
        self::assertCount(80, $allRules);
        ...
        self::assertCount(38, $notInRangeInAll);
