...
final class ListCommandTest extends TestCase
{
     ...
     * (ADR-004). Both arms pass --all so the two runs share the identical 64-rule id set and the
    ...
    public function testNotInRangeRulesAreHiddenByDefaultAndShownWithAll(): void
    {
        ...
        self::assertSame(64, $default['total']);
        self::assertSame(64, $all['total']);

        $defaultRules = self::objList($default['rules']);
        $allRules = self::objList($all['rules']);

        self::assertCount(41, $defaultRules);
        self::assertCount(64, $allRules);
        ...
        self::assertCount(23, $notInRangeInAll);
    ...
    public function testListRulesAliasRulesWorks(): void
    {
        ...
        self::assertSame(ExitCode::SUCCESS, $exitCode);
        self::assertStringContainsString('Rules: 64 of 64 shown', $tester->getDisplay());
    }
