...
final class ListCommandTest extends TestCase
{
     ...
     * (ADR-004). Both arms pass --all so the two runs share the identical 24-rule id set and the
    ...
    public function testNotInRangeRulesAreHiddenByDefaultAndShownWithAll(): void
    {
        ...
        self::assertSame(24, $default['total']);
        self::assertSame(24, $all['total']);

        $defaultRules = self::objList($default['rules']);
        $allRules = self::objList($all['rules']);

        self::assertCount(15, $defaultRules);
        self::assertCount(24, $allRules);
        ...
        self::assertCount(9, $notInRangeInAll);
    ...
    public function testListRulesAliasRulesWorks(): void
    {
        ...
        self::assertSame(ExitCode::SUCCESS, $exitCode);
        self::assertStringContainsString('Rules: 24 of 24 shown', $tester->getDisplay());
    }
