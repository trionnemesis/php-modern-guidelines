...
final class ListCommandTest extends TestCase
{
     ...
     * (ADR-004). Both arms pass --all so the two runs share the identical 16-rule id set and the
    ...
    public function testNotInRangeRulesAreHiddenByDefaultAndShownWithAll(): void
    {
        ...
        self::assertSame(16, $default['total']);
        self::assertSame(16, $all['total']);

        $defaultRules = self::objList($default['rules']);
        $allRules = self::objList($all['rules']);

        self::assertCount(9, $defaultRules);
        self::assertCount(16, $allRules);
        ...
        self::assertCount(7, $notInRangeInAll);
    ...
    public function testListRulesAliasRulesWorks(): void
    {
        ...
        self::assertSame(ExitCode::SUCCESS, $exitCode);
        self::assertStringContainsString('Rules: 16 of 16 shown', $tester->getDisplay());
    }
