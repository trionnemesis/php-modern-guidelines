...
- Verification must remain explicit, policy-aware and zero-mutation. Time, captured output and process trees stay bounded; missing executables, unsupported projections and unmapped findings stay visible. M3-A itself runs no real analyzer.
