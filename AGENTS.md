...
- Verification must remain explicit, policy-aware and zero-mutation. Missing executables, unsupported projections and unmapped findings stay visible; M3-A itself runs no real analyzer.
